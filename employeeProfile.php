        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto d-none d-md-block">
                <div class="middle">
                    ...
                    <a class="text-body" href="catalog.php">Каталог мастеров и цен</a>             
                </div>
            </div>
        ...
        <div class="container py-4 py-md-5">
            ...
            ?>
                <div class="col-md-4 col-lg-3 text-center mb-4 mb-md-0">
                    <img class="rounded-circle shadow" src="<?php if($row['AVATAR']) { echo $row['AVATAR']; } else { echo 'avatar/user.png';} ?>" width="200" height="200" alt="Мастер Иван Иванов">               
                </div>
               <?php } ?>
                    ...
                    <div class="bg-black-50 rounded-xl px-4 py-3 text-white text-center text-md-left shadow">
                     ...
                     //  echo $query;
                      ...
                      // $row = mysqli_fetch_row($result);
                       ...
                       $get_id = $_GET['uid'];    
                       $qr = "select max(rw.id) max_id from review rw where rw.ID_TO = $get_id";      
                       ...
                       if($max_id)
                       {
                       $qs = "SELECT count(*) c FROM `review` r, `users` u where r.id_from = u.id and r.ID_TO = $get_id and r.id != $max_id";
                      // echo $qs;
                       ...
                       ?>       
                        ...
                        <div class="mt-2">
                            <span class="text-warning pr-2">
                             ...
                             <a href="#reviews" rel="nofollow" class="small text-light"><?php if($qs2[0]['c']) { echo $qs2[0]['c']; } else { echo '0';} ?> отзыв(a,ов)</a>
                        </div>
...
<section class="container pt-5">
    <div class="row mb-4">
            ...
            <div class="border mb-5 py-3 px-4 rounded-xl shadow-sm position-relative">
                    ...
                    <?php  foreach($rows as $row) { ?>
                        <div class="col-auto pr-1">
                             <img class="rounded-circle" src="<?php if($row['AVATAR']) { echo $row['AVATAR']; } else { echo 'avatar/user.png';} ?>" width="58" height="58" alt="Мастер Иван Иванов">                                                    </div>
        ...
        <div class="col-lg-4">
            ...
            <?php } else { ?>
                <div class="px-4">
                <button type="button" id="send_msg_to_emp" class="btn btn-secondary btn-lg btn-block my-4" >                        
                    
                    <a class="btn btn-secondary btn-lg btn-block my-4" >
                        <svg class="mr-2 i is-envelope"><use xlink:href="#s-envelope" /></use></svg>Отправить сообщение</a>
            </div>
            <?php } ?>
            <div class="mb-3"><div id="w0_ms" style="display:none" class="alert-info alert" role="alert">
            Вам необходимо <a href="register.php">зарегистрироваться</a> либо <a href="login.php">войти</a>.
         </div></div>
...
<div class="modal modal-load fade show" id="add_review" tabindex="-1" data-modal-action="/profile/modal-review?user=36221" style="display: none; padding-right: 17px;" aria-modal="true" role="dialog">
    ...
    <?php }else { ?>
        <div class="modal-content">
            ...
            <div class="modal-footer"><a class="btn btn-primary" href="login.php">Войти</a><a class="btn btn-primary" href="register.php">Зарегистрироваться</a></div>
        </div>
    <?php } ?>
    </div>
</div>
        ...
        <div class="row justify-content-md-center">           
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 mb-4">
                 <div class="border p-1 shadow-sm rounded-lg position-relative pointer">
                    <a class="text-white" href="pics_master.php?user_id=<?php echo $_GET['uid']; ?>">
    ...
    align-items: center;">
        <div>   <h2 class="">Расценки</h2> </div>
            ...
            <div class="text-center text-muted mb-4">
                Цены актуальны на <?php echo last_date_price($_GET['uid']); ?>         
            </div>

            <?php $y =  count_price($_GET['uid']); if($y == 'NULL') {?>
        <div class="row justify-content-center">
    <div class="col-xl-10">
                    <div id="w4" class="alert-info alert-i alert" role="alert">
               ...
               <div class="col-lg-3">
                ...
                <div class="col-lg-6">
                    <div class="list-group shadow-sm mb-4">
                      ...
                      <?php echo get_price_ser_emp($_GET['uid']); ?>                        
...
<section id="contacts" class="py-5 bg-ultra-light">
    <div class="container">
        ...
        <div class="row justify-content-md-center">
            ...
            <div id="w0" style="display:none;" class="alert-info alert" role="alert">

Для просмотра номера телефона Вам необходимо <a href="register.php">зарегистрироваться</a> либо <a href="login.php">войти</a>.


</div>
                <div class="d-block mb-3 hidden-phone h4 font-weight-normal align-top">
                    <div class="float-left">
                        <svg id="show_number_ses_svg" class="text-body mr-2 i is-phone-alt"><use xlink:href="#s-phone-alt" /></use></svg>
                    </div>
                    <?php  foreach($rows as $row) {
                        $phone = $row['PHONE'];
                        ...
                        if(!$_SESSION) {
                        ?>
                     <div class=" show_number_ses" style="display: inline-block;">
                        <?php echo $hidden_num; ?>xxx xxxx<br>
                        <a class="view-phone text-muted small" href="#" id="show_n_s" data-type="1" data-id="5000">Показать номер</a>
                    </div>
                    <div class=" hide_number_ses" style="display:none">
                        <?php echo $row['PHONE']; ?><br>
                        <a class="view-phone text-muted small" href="#" id="hide_n_s" data-type="1" data-id="5000">Скрыть номер</a>
                    </div>
                        <?php } else { ?>
  ...
  <?php if(isset($_SESSION['id'])) { ?>
        <div class="row mt-4 mb-3">
            <div class="col text-center">
                <a id="message" data-id="<?php echo $_SESSION['id']; ?>" class="btn btn-secondary btn-lg btn-block my-4" >
                    <svg class="mr-2 i is-envelope"><use xlink:href="#s-envelope" /></use></svg>Отправить сообщение</a>           
            </div>
        </div>
  <?php }else{  ?>
  ...
  <?php } ?>
        <div class="mb-3"><div id="w0_msg" style="display:none" class="alert-info alert" role="alert">
            Вам необходимо <a href="register.php">зарегистрироваться</a> либо <a href="login.php">войти</a>.
         </div></div>
...
$('#show_n_s').click(function(){
    ...
    $('#show_number_ses_svg').hide();
 //   $('.hide_number').css('display', 'inline-block');
 //   $('.hide_number').show();    
  $('.show_number_ses').hide();
  $('#w0').show();
  // alert('Для просмотра необходимо зарегистрироваться!');
})

$('#send_msg_to_emp').click(function(){
    $('#w0_ms').show();
})
