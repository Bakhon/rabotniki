...
<section class="container pt-5">
    ...
    justify-content: space-around;"> 
                ...
                <div><a class="edit_services" data-id="<?php echo $_SESSION['id']; ?>" data-toggle="modal" data-target="#edit_services" style="margin-left: 120px;"> <i class="fa fa-pencil" aria-hidden="true"></i> </a></div>
           </div> 
...
<div class="modal modal-load fade show" id="edit_services" tabindex="-1" data-modal-action="/profile/modal-review?user=36221" style="display: none; padding-right: 17px;" aria-modal="true" role="dialog">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title">Отредактировать</h5>
            <button type="button" class="close" data-dismiss="modal">
            <span aria-hidden="true">×</span>
            </button>
         </div>
         <div class="modal-body">
            <div class="mb-3">
               <div class="form-group">            
                  <input type="hidden" name="user_id" id="user_id" value="<?php echo isset($_SESSION['id']); ?>" />															
               </div>
              <div id="vue"> 
         ...
         <div class="modal-footer"><input type="submit" name="send_photo" id="send_photo" class="btn btn-primary btn-lg btn-block register2" value="Сохранить"/></div>
      </div>
   </div>
</div>
</div>
...
$(document).ready(function(){
    ...
    $('.edit_services').click(function(){
        $check = $(this).attr("data-id");
          $.post('php/employee.php', {"service_check": $check}, function(d){
                  $('#vue').html(d);
        })
      //  console.log($check);
        $('.check').each(function(){
